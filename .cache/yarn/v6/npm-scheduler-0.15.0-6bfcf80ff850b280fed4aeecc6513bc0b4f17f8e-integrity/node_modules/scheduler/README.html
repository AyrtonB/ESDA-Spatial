...
<html>
  <head>
    ...
    <title>scheduler &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-scheduler-0.15.0-6bfcf80ff850b280fed4aeecc6513bc0b4f17f8e-integrity/node_modules/scheduler/README.md"><button type="button"
...
<h1><code class="docutils literal notranslate"><span class="pre">scheduler</span></code><a class="headerlink" href="#scheduler" title="Permalink to this headline">¶</a></h1>
...
<p>The React team thanks <a class="reference external" href="https://podviaznikov.com/">Anton Podviaznikov</a> for donating the <code class="docutils literal notranslate"><span class="pre">scheduler</span></code> package name.</p>
</div>
</div>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-scheduler-0.15.0-6bfcf80ff850b280fed4aeecc6513bc0b4f17f8e-integrity/node_modules/scheduler"
        },

...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-commander-2.20.3-fd485e84c03eb4881c20722ba48035e8531aeb33-integrity/node_modules/commander/Readme.md"><button type="button"
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#option-parsing">
   Option parsing
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#command-specific-options">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#regular-expression">
   Regular Expression
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#variadic-arguments">
   Variadic arguments
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#git-style-sub-commands">
   Git-style sub-commands
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#harmony">
...
<a class="reference external" href="https://packagephobia.now.sh/result?p=commander"><img alt="Install Size" src="https://packagephobia.now.sh/badge?p=commander" /></a>
<a class="reference external" href="https://gitter.im/tj/commander.js?utm_source=badge&amp;utm_medium=badge&amp;utm_campaign=pr-badge&amp;utm_content=badge"><img alt="Join the chat at https://gitter.im/tj/commander.js" src="https://badges.gitter.im/Join%20Chat.svg" /></a></p>
<p>The complete solution for <a class="reference external" href="http://nodejs.org">node.js</a> command-line interfaces, inspired by Ruby’s <a class="reference external" href="https://github.com/commander-rb/commander">commander</a>.<br />
<a class="reference external" href="http://tj.github.com/commander.js/">API documentation</a></p>
<div class="section" id="installation">
<h2>Installation<a class="headerlink" href="#installation" title="Permalink to this headline">¶</a></h2>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>$ npm install commander
</pre></div>
</div>
</div>
...
<p>Options with commander are defined with the <code class="docutils literal notranslate"><span class="pre">.option()</span></code> method, also serving as documentation for the options. The example below parses args and options from <code class="docutils literal notranslate"><span class="pre">process.argv</span></code>, leaving remaining args as the <code class="docutils literal notranslate"><span class="pre">program.args</span></code> array which were not consumed by options.</p>
...
<p>Short flags may be passed as a single arg, for example <code class="docutils literal notranslate"><span class="pre">-abc</span></code> is equivalent to <code class="docutils literal notranslate"><span class="pre">-a</span> <span class="pre">-b</span> <span class="pre">-c</span></code>. Multi-word options such as “–template-engine” are camel-cased, becoming <code class="docutils literal notranslate"><span class="pre">program.templateEngine</span></code> etc.</p>
<p>Note that multi-word options starting with <code class="docutils literal notranslate"><span class="pre">--no</span></code> prefix negate the boolean value of the following word. For example, <code class="docutils literal notranslate"><span class="pre">--no-sauce</span></code> sets the value of <code class="docutils literal notranslate"><span class="pre">program.sauce</span></code> to false.</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;you ordered a pizza&#39;</span><span class="p">);</span>
<span class="k">if</span> <span class="p">(</span><span class="nx">program</span><span class="p">.</span><span class="nx">sauce</span><span class="p">)</span> <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;  with sauce&#39;</span><span class="p">);</span>
<span class="k">else</span> <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39; without sauce&#39;</span><span class="p">);</span>
</pre></div>
</div>
<p>To get string arguments from options you will need to use angle brackets &lt;&gt; for required inputs or square brackets [] for optional inputs.</p>
<p>e.g. <code class="docutils literal notranslate"><span class="pre">.option('-m</span> <span class="pre">--myarg</span> <span class="pre">[myVar]',</span> <span class="pre">'my</span> <span class="pre">super</span> <span class="pre">cool</span> <span class="pre">description')</span></code></p>
<p>Then to access the input if it was passed in.</p>
<p>e.g. <code class="docutils literal notranslate"><span class="pre">var</span> <span class="pre">myInput</span> <span class="pre">=</span> <span class="pre">program.myarg</span></code></p>
<p><strong>NOTE</strong>: If you pass a argument without using brackets the example above will return true and not the value passed in.</p>
</div>
<div class="section" id="version-option">
<h2>Version option<a class="headerlink" href="#version-option" title="Permalink to this headline">¶</a></h2>
<p>Calling the <code class="docutils literal notranslate"><span class="pre">version</span></code> implicitly adds the <code class="docutils literal notranslate"><span class="pre">-V</span></code> and <code class="docutils literal notranslate"><span class="pre">--version</span></code> options to the command.
When either of these options is present, the command prints the version number and exits.</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>$ ./examples/pizza -V
0.0.1
</pre></div>
</div>
<p>If you want your program to respond to the <code class="docutils literal notranslate"><span class="pre">-v</span></code> option instead of the <code class="docutils literal notranslate"><span class="pre">-V</span></code> option, simply pass custom flags to the <code class="docutils literal notranslate"><span class="pre">version</span></code> method using the same syntax as the <code class="docutils literal notranslate"><span class="pre">option</span></code> method.</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">program</span>
  <span class="p">.</span><span class="nx">version</span><span class="p">(</span><span class="s1">&#39;0.0.1&#39;</span><span class="p">,</span> <span class="s1">&#39;-v, --version&#39;</span><span class="p">)</span>
</pre></div>
</div>
<p>The version flags can be named anything, but the long option is required.</p>
</div>
<div class="section" id="command-specific-options">
<h2>Command-specific options<a class="headerlink" href="#command-specific-options" title="Permalink to this headline">¶</a></h2>
...
<span class="nx">program</span>
  ...
  <span class="p">.</span><span class="nx">action</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">dir</span><span class="p">,</span> <span class="nx">cmd</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;remove &#39;</span> <span class="o">+</span> <span class="nx">dir</span> <span class="o">+</span> <span class="p">(</span><span class="nx">cmd</span><span class="p">.</span><span class="nx">recursive</span> <span class="o">?</span> <span class="s1">&#39; recursively&#39;</span> <span class="o">:</span> <span class="s1">&#39;&#39;</span><span class="p">))</span>
  <span class="p">})</span>
...
<h2>Coercion<a class="headerlink" href="#coercion" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">function</span> <span class="nx">range</span><span class="p">(</span><span class="nx">val</span><span class="p">)</span> <span class="p">{</span>
...
<span class="kd">function</span> <span class="nx">increaseVerbosity</span><span class="p">(</span><span class="nx">v</span><span class="p">,</span> <span class="nx">total</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="nx">total</span> <span class="o">+</span> <span class="mf">1</span><span class="p">;</span>
<span class="p">}</span>
...
<span class="nx">program</span>
  ...
  <span class="p">.</span><span class="nx">option</span><span class="p">(</span><span class="s1">&#39;-v, --verbose&#39;</span><span class="p">,</span> <span class="s1">&#39;A value that can be increased&#39;</span><span class="p">,</span> <span class="nx">increaseVerbosity</span><span class="p">,</span> <span class="mf">0</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">);</span>
...
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39; range: %j..%j&#39;</span><span class="p">,</span> <span class="nx">program</span><span class="p">.</span><span class="nx">range</span><span class="p">[</span><span class="mf">0</span><span class="p">],</span> <span class="nx">program</span><span class="p">.</span><span class="nx">range</span><span class="p">[</span><span class="mf">1</span><span class="p">]);</span>
...
<h2>Regular Expression<a class="headerlink" href="#regular-expression" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">program</span>
  <span class="p">.</span><span class="nx">version</span><span class="p">(</span><span class="s1">&#39;0.1.0&#39;</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">option</span><span class="p">(</span><span class="s1">&#39;-s --size &lt;size&gt;&#39;</span><span class="p">,</span> <span class="s1">&#39;Pizza size&#39;</span><span class="p">,</span> <span class="sr">/^(large|medium|small)$/i</span><span class="p">,</span> <span class="s1">&#39;medium&#39;</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">option</span><span class="p">(</span><span class="s1">&#39;-d --drink [drink]&#39;</span><span class="p">,</span> <span class="s1">&#39;Drink&#39;</span><span class="p">,</span> <span class="sr">/^(coke|pepsi|izze)$/i</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">);</span>
...
append <code class="docutils literal notranslate"><span class="pre">...</span></code> to the argument name.  Here is an example:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
<p>An <code class="docutils literal notranslate"><span class="pre">Array</span></code> is used for the value of a variadic argument.  This applies to <code class="docutils literal notranslate"><span class="pre">program.args</span></code> as well as the argument passed
to your action as demonstrated above.</p>
</div>
<div class="section" id="specify-the-argument-syntax">
<h2>Specify the argument syntax<a class="headerlink" href="#specify-the-argument-syntax" title="Permalink to this headline">¶</a></h2>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
<p>Angled brackets (e.g. <code class="docutils literal notranslate"><span class="pre">&lt;cmd&gt;</span></code>) indicate required input. Square brackets (e.g. <code class="docutils literal notranslate"><span class="pre">[env]</span></code>) indicate optional input.</p>
</div>
<div class="section" id="git-style-sub-commands">
<h2>Git-style sub-commands<a class="headerlink" href="#git-style-sub-commands" title="Permalink to this headline">¶</a></h2>
...
<p>When <code class="docutils literal notranslate"><span class="pre">.command()</span></code> is invoked with a description argument, no <code class="docutils literal notranslate"><span class="pre">.action(callback)</span></code> should be called to handle sub-commands, otherwise there will be an error. This tells commander that you’re going to use separate executables for sub-commands, much like <code class="docutils literal notranslate"><span class="pre">git(1)</span></code> and other popular tools.<br />
The commander will try to search the executables in the directory of the entry script (like <code class="docutils literal notranslate"><span class="pre">./examples/pm</span></code>) with the name <code class="docutils literal notranslate"><span class="pre">program-command</span></code>, like <code class="docutils literal notranslate"><span class="pre">pm-install</span></code>, <code class="docutils literal notranslate"><span class="pre">pm-search</span></code>.</p>
<p>Options can be passed with the call to <code class="docutils literal notranslate"><span class="pre">.command()</span></code>. Specifying <code class="docutils literal notranslate"><span class="pre">true</span></code> for <code class="docutils literal notranslate"><span class="pre">opts.noHelp</span></code> will remove the subcommand from the generated help output. Specifying <code class="docutils literal notranslate"><span class="pre">true</span></code> for <code class="docutils literal notranslate"><span class="pre">opts.isDefault</span></code> will run the subcommand if no other subcommand is specified.</p>
...
<h3><code class="docutils literal notranslate"><span class="pre">--harmony</span></code><a class="headerlink" href="#harmony" title="Permalink to this headline">¶</a></h3>
<p>You can enable <code class="docutils literal notranslate"><span class="pre">--harmony</span></code> option in two ways:</p>
<ul class="simple">
<li><p>Use <code class="docutils literal notranslate"><span class="pre">#!</span> <span class="pre">/usr/bin/env</span> <span class="pre">node</span> <span class="pre">--harmony</span></code> in the sub-commands scripts. Note some os version don’t support this pattern.</p></li>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ./examples/pizza --help
Usage: pizza [options]
...
<h2>Custom help<a class="headerlink" href="#custom-help" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>Usage: custom-help [options]
...
<h2>.outputHelp(cb)<a class="headerlink" href="#outputhelp-cb" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">program</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;commander&#39;</span><span class="p">);</span>
...
<h2>.help(cb)<a class="headerlink" href="#help-cb" title="Permalink to this headline">¶</a></h2>

...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../../../../../_sources/.cache/yarn/v6/npm-@blueprintjs-core-3.29.0-3b8df57e512f9e42623ee21a3fe71fa13c2b7ba1-integrity/node_modules/@blueprintjs/core/src/components/non-ideal-state/non-ideal-state.md"><button type="button"
...
<ul class="simple">
<li><p><strong>Empty state:</strong> a container has just been created and has no data in it yet,
or a container’s contents have been intentionally removed.</p></li>
<li><p><strong>Loading state:</strong> a container is awaiting data. A good practice is to show a
spinner for this state, with optional explanatory text below the spinner.</p></li>
<li><p><strong>Error state:</strong> something went wrong (for instance, 404 and 500 HTTP errors).
In this case, a good practice is to add a call to action directing the user
what to do next.</p></li>
</ul>
<p>&#64;reactExample NonIdealStateExample</p>
<p>&#64;## Props</p>
...
<li><p><code class="docutils literal notranslate"><span class="pre">children</span></code></p></li>
</ol>
<p>&#64;interface INonIdealStateProps</p>
<p>&#64;## CSS</p>
<p>Apply <code class="docutils literal notranslate"><span class="pre">.&#64;ns-non-ideal-state</span></code> to the container and <code class="docutils literal notranslate"><span class="pre">.&#64;ns-non-ideal-state-visual</span></code>
...
<p>&#64;css non-ideal-state</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-@blueprintjs-core-3.29.0-3b8df57e512f9e42623ee21a3fe71fa13c2b7ba1-integrity/node_modules/@blueprintjs/core/src/components/non-ideal-state"
        },

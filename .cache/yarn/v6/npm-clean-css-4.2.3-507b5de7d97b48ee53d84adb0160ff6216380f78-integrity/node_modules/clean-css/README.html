...
<html>
  <head>
    ...
    <title>Node.js version support &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-clean-css-4.2.3-507b5de7d97b48ee53d84adb0160ff6216380f78-integrity/node_modules/clean-css/README.md"><button type="button"
...
<div class="section" id="node-js-version-support">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">CleanCSS</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;clean-css&#39;</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">input</span> <span class="o">=</span> <span class="s1">&#39;a{font-weight:bold;}&#39;</span><span class="p">;</span>
...
<div class="section" id="important-4-0-breaking-changes">
...
<div class="section" id="what-s-new-in-version-4-1">
...
<div class="section" id="what-s-new-in-version-4-2">
...
<div class="section" id="compatibility-modes">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">compatibility</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">colors</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">opacity</span><span class="o">:</span> <span class="kc">true</span> <span class="c1">// controls `rgba()` / `hsla()` color support</span>
    <span class="p">},</span>
    <span class="nx">properties</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">backgroundClipMerging</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls background-clip merging into shorthand</span>
      <span class="nx">backgroundOriginMerging</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls background-origin merging into shorthand</span>
      <span class="nx">backgroundSizeMerging</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls background-size merging into shorthand</span>
      <span class="nx">colors</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls color optimizations</span>
      <span class="nx">ieBangHack</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls keeping IE bang hack</span>
      <span class="nx">ieFilters</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls keeping IE `filter` / `-ms-filter`</span>
      <span class="nx">iePrefixHack</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls keeping IE prefix hack</span>
      <span class="nx">ieSuffixHack</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls keeping IE suffix hack</span>
      <span class="nx">merging</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls property merging based on understandability</span>
      <span class="nx">shorterLengthUnits</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls shortening pixel units into `pc`, `pt`, or `in` units</span>
      <span class="nx">spaceAfterClosingBrace</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls keeping space after closing brace - `url() no-repeat` into `url()no-repeat`</span>
      <span class="nx">urlQuotes</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls keeping quoting inside `url()`</span>
      <span class="nx">zeroUnits</span><span class="o">:</span> <span class="kc">true</span> <span class="c1">// controls removal of units `0` value</span>
    <span class="p">},</span>
    <span class="nx">selectors</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">adjacentSpace</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls extra space before `nav` element</span>
      <span class="nx">ie7Hack</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls removal of IE7 selector hacks, e.g. `*+html...`</span>
      <span class="nx">mergeablePseudoClasses</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;:active&#39;</span><span class="p">,</span> <span class="p">...],</span> <span class="c1">// controls a whitelist of mergeable pseudo classes</span>
      <span class="nx">mergeablePseudoElements</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;::after&#39;</span><span class="p">,</span> <span class="p">...],</span> <span class="c1">// controls a whitelist of mergeable pseudo elements</span>
      <span class="nx">mergeLimit</span><span class="o">:</span> <span class="mf">8191</span><span class="p">,</span> <span class="c1">// controls maximum number of selectors in a single rule (since 4.1.0)</span>
      <span class="nx">multiplePseudoMerging</span><span class="o">:</span> <span class="kc">true</span> <span class="c1">// controls merging of rules with multiple pseudo classes / elements (since 4.1.0)</span>
    <span class="p">},</span>
    <span class="nx">units</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">ch</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `ch` as a supported unit</span>
      <span class="k">in</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `in` as a supported unit</span>
      <span class="nx">pc</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `pc` as a supported unit</span>
      <span class="nx">pt</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `pt` as a supported unit</span>
      <span class="nx">rem</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `rem` as a supported unit</span>
      <span class="nx">vh</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `vh` as a supported unit</span>
      <span class="nx">vm</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `vm` as a supported unit</span>
      <span class="nx">vmax</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls treating `vmax` as a supported unit</span>
      <span class="nx">vmin</span><span class="o">:</span> <span class="kc">true</span> <span class="c1">// controls treating `vmin` as a supported unit</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">})</span>
</pre></div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">compatibility</span><span class="o">:</span> <span class="s1">&#39;ie9,-properties.merging&#39;</span> <span class="c1">// sets compatibility to IE9 mode with disabled property merging</span>
<span class="p">})</span>
</pre></div>
</div>
</div>
<div class="section" id="fetch-option">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">request</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;request&#39;</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">source</span> <span class="o">=</span> <span class="s1">&#39;@import url(http://example.com/path/to/stylesheet.css);&#39;</span><span class="p">;</span>
<span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">fetch</span><span class="o">:</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">uri</span><span class="p">,</span> <span class="nx">inlineRequest</span><span class="p">,</span> <span class="nx">inlineTimeout</span><span class="p">,</span> <span class="nx">callback</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">request</span><span class="p">(</span><span class="nx">uri</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">response</span><span class="p">,</span> <span class="nx">body</span><span class="p">)</span> <span class="p">{</span>
      ...
      <span class="p">}</span> <span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="nx">response</span> <span class="o">&amp;&amp;</span> <span class="nx">response</span><span class="p">.</span><span class="nx">statusCode</span> <span class="o">!=</span> <span class="mf">200</span><span class="p">)</span> <span class="p">{</span>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">format</span><span class="o">:</span> <span class="s1">&#39;beautify&#39;</span> <span class="c1">// formats output in a really nice way</span>
<span class="p">})</span>
</pre></div>
</div>
<p>and</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">format</span><span class="o">:</span> <span class="s1">&#39;keep-breaks&#39;</span> <span class="c1">// formats output the default way but adds line breaks for improved readability</span>
<span class="p">})</span>
</pre></div>
</div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">format</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">breaks</span><span class="o">:</span> <span class="p">{</span> <span class="c1">// controls where to insert breaks</span>
      <span class="nx">afterAtRule</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after an at-rule; e.g. `@charset`; defaults to `false`</span>
      <span class="nx">afterBlockBegins</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after a block begins; e.g. `@media`; defaults to `false`</span>
      <span class="nx">afterBlockEnds</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after a block ends, defaults to `false`</span>
      <span class="nx">afterComment</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after a comment; defaults to `false`</span>
      <span class="nx">afterProperty</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after a property; defaults to `false`</span>
      <span class="nx">afterRuleBegins</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after a rule begins; defaults to `false`</span>
      <span class="nx">afterRuleEnds</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes after a rule ends; defaults to `false`</span>
      <span class="nx">beforeBlockEnds</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a line break comes before a block ends; defaults to `false`</span>
      <span class="nx">betweenSelectors</span><span class="o">:</span> <span class="kc">false</span> <span class="c1">// controls if a line break comes between selectors; defaults to `false`</span>
    <span class="p">},</span>
    <span class="nx">breakWith</span><span class="o">:</span> <span class="s1">&#39;\n&#39;</span><span class="p">,</span> <span class="c1">// controls the new line character, can be `&#39;\r\n&#39;` or `&#39;\n&#39;` (aliased as `&#39;windows&#39;` and `&#39;unix&#39;` or `&#39;crlf&#39;` and `&#39;lf&#39;`); defaults to system one, so former on Windows and latter on Unix</span>
    <span class="nx">indentBy</span><span class="o">:</span> <span class="mf">0</span><span class="p">,</span> <span class="c1">// controls number of characters to indent with; defaults to `0`</span>
    <span class="nx">indentWith</span><span class="o">:</span> <span class="s1">&#39;space&#39;</span><span class="p">,</span> <span class="c1">// controls a character to indent with, can be `&#39;space&#39;` or `&#39;tab&#39;`; defaults to `&#39;space&#39;`</span>
    <span class="nx">spaces</span><span class="o">:</span> <span class="p">{</span> <span class="c1">// controls where to insert spaces</span>
      <span class="nx">aroundSelectorRelation</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if spaces come around selector relations; e.g. `div &gt; a`; defaults to `false`</span>
      <span class="nx">beforeBlockBegins</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls if a space comes before a block begins; e.g. `.block {`; defaults to `false`</span>
      <span class="nx">beforeValue</span><span class="o">:</span> <span class="kc">false</span> <span class="c1">// controls if a space comes before a value; e.g. `width: 1rem`; defaults to `false`</span>
    <span class="p">},</span>
    <span class="nx">wrapAt</span><span class="o">:</span> <span class="kc">false</span> <span class="c1">// controls maximum line length; defaults to `false`</span>
  <span class="p">}</span>
<span class="p">})</span>
</pre></div>
</div>
</div>
<div class="section" id="inlining-options">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">inline</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;local&#39;</span><span class="p">]</span> <span class="c1">// default; enables local inlining only</span>
<span class="p">})</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">inline</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;none&#39;</span><span class="p">]</span> <span class="c1">// disables all inlining</span>
<span class="p">})</span>
</pre></div>
</div>
...
<span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">inline</span><span class="o">:</span> <span class="kc">false</span> <span class="c1">// disables all inlining (alias to `[&#39;none&#39;]`)</span>
<span class="p">})</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">inline</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;all&#39;</span><span class="p">]</span> <span class="c1">// enables all inlining, same as [&#39;local&#39;, &#39;remote&#39;]</span>
<span class="p">})</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">inline</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;local&#39;</span><span class="p">,</span> <span class="s1">&#39;mydomain.example.com&#39;</span><span class="p">]</span> <span class="c1">// enables local inlining plus given remote source</span>
<span class="p">})</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">inline</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;local&#39;</span><span class="p">,</span> <span class="s1">&#39;remote&#39;</span><span class="p">,</span> <span class="s1">&#39;!fonts.googleapis.com&#39;</span><span class="p">]</span> <span class="c1">// enables all inlining but from given remote source</span>
<span class="p">})</span>
</pre></div>
</div>
</div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="mf">2</span>
<span class="p">})</span>
</pre></div>
</div>
...
<div class="section" id="level-0-optimizations">
...
<div class="section" id="level-1-optimizations">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="p">{</span>
    <span class="mf">1</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">cleanupCharsets</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `@charset` moving to the front of a stylesheet; defaults to `true`</span>
      <span class="nx">normalizeUrls</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls URL normalization; defaults to `true`</span>
      <span class="nx">optimizeBackground</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `background` property optimizations; defaults to `true`</span>
      <span class="nx">optimizeBorderRadius</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `border-radius` property optimizations; defaults to `true`</span>
      <span class="nx">optimizeFilter</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `filter` property optimizations; defaults to `true`</span>
      <span class="nx">optimizeFont</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `font` property optimizations; defaults to `true`</span>
      <span class="nx">optimizeFontWeight</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `font-weight` property optimizations; defaults to `true`</span>
      <span class="nx">optimizeOutline</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `outline` property optimizations; defaults to `true`</span>
      <span class="nx">removeEmpty</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls removing empty rules and nested blocks; defaults to `true`</span>
      <span class="nx">removeNegativePaddings</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls removing negative paddings; defaults to `true`</span>
      <span class="nx">removeQuotes</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls removing quotes when unnecessary; defaults to `true`</span>
      <span class="nx">removeWhitespace</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls removing unused whitespace; defaults to `true`</span>
      <span class="nx">replaceMultipleZeros</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// contols removing redundant zeros; defaults to `true`</span>
      <span class="nx">replaceTimeUnits</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls replacing time units with shorter values; defaults to `true`</span>
      <span class="nx">replaceZeroUnits</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls replacing zero values with units; defaults to `true`</span>
      <span class="nx">roundingPrecision</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// rounds pixel values to `N` decimal places; `false` disables rounding; defaults to `false`</span>
      <span class="nx">selectorsSortingMethod</span><span class="o">:</span> <span class="s1">&#39;standard&#39;</span><span class="p">,</span> <span class="c1">// denotes selector sorting method; can be `&#39;natural&#39;` or `&#39;standard&#39;`, `&#39;none&#39;`, or false (the last two since 4.1.0); defaults to `&#39;standard&#39;`</span>
      <span class="nx">specialComments</span><span class="o">:</span> <span class="s1">&#39;all&#39;</span><span class="p">,</span> <span class="c1">// denotes a number of /*! ... */ comments preserved; defaults to `all`</span>
      <span class="nx">tidyAtRules</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls at-rules (e.g. `@charset`, `@import`) optimizing; defaults to `true`</span>
      <span class="nx">tidyBlockScopes</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls block scopes (e.g. `@media`) optimizing; defaults to `true`</span>
      <span class="nx">tidySelectors</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls selectors optimizing; defaults to `true`,</span>
      <span class="nx">semicolonAfterLastProperty</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls removing trailing semicolons in rule; defaults to `false` - means remove</span>
      <span class="nx">transform</span><span class="o">:</span> <span class="kd">function</span> <span class="p">()</span> <span class="p">{}</span> <span class="c1">// defines a callback for fine-grained property optimization; defaults to no-op</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">});</span>
</pre></div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="p">{</span>
    <span class="mf">1</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">all</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// set all values to `false`</span>
      <span class="nx">tidySelectors</span><span class="o">:</span> <span class="kc">true</span> <span class="c1">// turns on optimizing selectors</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">});</span>
</pre></div>
...
<div class="section" id="level-2-optimizations">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="p">{</span>
    <span class="mf">2</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">mergeAdjacentRules</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls adjacent rules merging; defaults to true</span>
      <span class="nx">mergeIntoShorthands</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls merging properties into shorthands; defaults to true</span>
      <span class="nx">mergeMedia</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls `@media` merging; defaults to true</span>
      <span class="nx">mergeNonAdjacentRules</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls non-adjacent rule merging; defaults to true</span>
      <span class="nx">mergeSemantically</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls semantic merging; defaults to false</span>
      <span class="nx">overrideProperties</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls property overriding based on understandability; defaults to true</span>
      <span class="nx">removeEmpty</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls removing empty rules and nested blocks; defaults to `true`</span>
      <span class="nx">reduceNonAdjacentRules</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls non-adjacent rule reducing; defaults to true</span>
      <span class="nx">removeDuplicateFontRules</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls duplicate `@font-face` removing; defaults to true</span>
      <span class="nx">removeDuplicateMediaBlocks</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls duplicate `@media` removing; defaults to true</span>
      <span class="nx">removeDuplicateRules</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="c1">// controls duplicate rules removing; defaults to true</span>
      <span class="nx">removeUnusedAtRules</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls unused at rule removing; defaults to false (available since 4.1.0)</span>
      <span class="nx">restructureRules</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// controls rule restructuring; defaults to false</span>
      <span class="nx">skipProperties</span><span class="o">:</span> <span class="p">[]</span> <span class="c1">// controls which properties won&#39;t be optimized, defaults to `[]` which means all will be optimized (since 4.1.0)</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">});</span>
</pre></div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="p">{</span>
    <span class="mf">2</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">all</span><span class="o">:</span> <span class="kc">false</span><span class="p">,</span> <span class="c1">// sets all values to `false`</span>
      <span class="nx">removeDuplicateRules</span><span class="o">:</span> <span class="kc">true</span> <span class="c1">// turns on removing duplicate rules</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">});</span>
</pre></div>
...
<div class="section" id="minify-method">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">output</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">(</span><span class="nx">options</span><span class="p">).</span><span class="nx">minify</span><span class="p">(</span><span class="nx">source</span><span class="p">);</span>
</pre></div>
</div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">output</span><span class="p">.</span><span class="nx">styles</span><span class="p">);</span> <span class="c1">// optimized output CSS as a string</span>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span> <span class="nx">returnPromise</span><span class="o">:</span> <span class="kc">true</span> <span class="p">})</span>
  <span class="p">.</span><span class="nx">minify</span><span class="p">(</span><span class="nx">source</span><span class="p">)</span>
...
<div class="section" id="cli-utility">
...
<div class="section" id="how-to-optimize-multiple-files">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">().</span><span class="nx">minify</span><span class="p">([</span><span class="s1">&#39;path/to/file/one&#39;</span><span class="p">,</span> <span class="s1">&#39;path/to/file/two&#39;</span><span class="p">]);</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">().</span><span class="nx">minify</span><span class="p">({</span>
  <span class="s1">&#39;path/to/file/one&#39;</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">styles</span><span class="o">:</span> <span class="s1">&#39;contents of file one&#39;</span>
  <span class="p">},</span>
  <span class="s1">&#39;path/to/file/two&#39;</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">styles</span><span class="o">:</span> <span class="s1">&#39;contents of file two&#39;</span>
  <span class="p">}</span>
<span class="p">});</span>
</pre></div>
</div>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">().</span><span class="nx">minify</span><span class="p">([</span>
  <span class="p">{</span><span class="s1">&#39;path/to/file/one&#39;</span><span class="o">:</span> <span class="p">{</span><span class="nx">styles</span><span class="o">:</span> <span class="s1">&#39;contents of file one&#39;</span><span class="p">}},</span>
  <span class="p">{</span><span class="s1">&#39;path/to/file/two&#39;</span><span class="o">:</span> <span class="p">{</span><span class="nx">styles</span><span class="o">:</span> <span class="s1">&#39;contents of file two&#39;</span><span class="p">}}</span>
<span class="p">]);</span>
</pre></div>
</div>
...
<div class="section" id="how-to-process-remote-imports-correctly">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">source</span> <span class="o">=</span> <span class="s1">&#39;@import url(http://example.com/path/to/remote/styles);&#39;</span><span class="p">;</span>
<span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span> <span class="nx">inline</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;remote&#39;</span><span class="p">]</span> <span class="p">}).</span><span class="nx">minify</span><span class="p">(</span><span class="nx">source</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">error</span><span class="p">,</span> <span class="nx">output</span><span class="p">)</span> <span class="p">{</span>
...
<div class="section" id="how-to-apply-arbitrary-transformations-to-css-properties">
...
<div class="section" id="how-to-specify-a-custom-rounding-precision">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="p">{</span>
    <span class="mf">1</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">roundingPrecision</span><span class="o">:</span> <span class="s1">&#39;all=3,px=5&#39;</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">}).</span><span class="nx">minify</span><span class="p">(</span><span class="nx">source</span><span class="p">)</span>
</pre></div>
...
<div class="section" id="how-to-keep-a-css-fragment-intact">
...
<div class="highlight-css notranslate"><div class="highlight"><pre><span></span><span class="p">.</span><span class="nc">block-1</span> <span class="p">{</span>
  <span class="k">color</span><span class="p">:</span> <span class="kc">red</span>
<span class="p">}</span>
<span class="c">/* clean-css ignore:start */</span>
<span class="p">.</span><span class="nc">block-special</span> <span class="p">{</span>
  <span class="k">color</span><span class="p">:</span> <span class="kc">transparent</span>
<span class="p">}</span>
<span class="c">/* clean-css ignore:end */</span>
<span class="p">.</span><span class="nc">block-2</span> <span class="p">{</span>
  <span class="k">margin</span><span class="p">:</span> <span class="mi">0</span>
<span class="p">}</span>
</pre></div>
</div>
...
<div class="section" id="how-to-preserve-a-comment-block">
...
<div class="section" id="how-to-rebase-relative-image-urls">
...
<div class="section" id="how-to-work-with-source-maps">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span> <span class="nx">sourceMap</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="nx">rebaseTo</span><span class="o">:</span> <span class="nx">pathToOutputDirectory</span> <span class="p">})</span>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span> <span class="nx">sourceMap</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="nx">rebaseTo</span><span class="o">:</span> <span class="nx">pathToOutputDirectory</span> <span class="p">}).</span><span class="nx">minify</span><span class="p">({</span>
  <span class="s1">&#39;path/to/source/1&#39;</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">styles</span><span class="o">:</span> <span class="s1">&#39;...styles...&#39;</span><span class="p">,</span>
    <span class="nx">sourceMap</span><span class="o">:</span> <span class="s1">&#39;...source-map...&#39;</span>
  <span class="p">},</span>
  <span class="s1">&#39;path/to/source/2&#39;</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">styles</span><span class="o">:</span> <span class="s1">&#39;...styles...&#39;</span><span class="p">,</span>
    <span class="nx">sourceMap</span><span class="o">:</span> <span class="s1">&#39;...source-map...&#39;</span>
  <span class="p">}</span>
...
<div class="section" id="how-to-apply-level-1-2-optimizations-at-the-same-time">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">new</span> <span class="nx">CleanCSS</span><span class="p">({</span>
  <span class="nx">level</span><span class="o">:</span> <span class="p">{</span>
    <span class="mf">1</span><span class="o">:</span> <span class="p">{</span>
      ...
      <span class="nx">normalizeUrls</span><span class="o">:</span> <span class="kc">false</span>
    <span class="p">},</span>
    <span class="mf">2</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">restructureRules</span><span class="o">:</span> <span class="kc">true</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">})</span>
</pre></div>
...
<div class="section" id="what-level-2-optimizations-do">
...
<div class="section" id="how-to-use-clean-css-with-build-tools">
...
<div class="section" id="how-to-use-clean-css-from-web-browser">
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>git clone git@github.com:jakubpawlowicz/clean-css.git
</pre></div>
</div>
<p>then install dependencies:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span><span class="nb">cd</span> clean-css
npm install
</pre></div>
</div>
<p>then use any of the following commands to verify your copy:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>npm run bench <span class="c1"># for clean-css benchmarks (see [test/bench.js](https://github.com/jakubpawlowicz/clean-css/blob/master/test/bench.js) for details)</span>
npm run browserify <span class="c1"># to create the browser-ready clean-css version</span>
npm run check <span class="c1"># to lint JS sources with [JSHint](https://github.com/jshint/jshint/)</span>
npm <span class="nb">test</span> <span class="c1"># to run all tests</span>
</pre></div>
</div>
</div>
</div>

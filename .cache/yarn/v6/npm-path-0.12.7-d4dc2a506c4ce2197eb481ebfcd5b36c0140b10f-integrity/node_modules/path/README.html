...
<html>
  <head>
    ...
    <title>path &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-path-0.12.7-d4dc2a506c4ce2197eb481ebfcd5b36c0140b10f-integrity/node_modules/path/README.md"><button type="button"
...
<p>This is an exact copy of the NodeJS ’path’ module published to the NPM registry.</p>
<p><a class="reference external" href="http://nodejs.org/docs/latest/api/path.html">Documentation</a></p>
<div class="section" id="install">
<h2>Install<a class="headerlink" href="#install" title="Permalink to this headline">¶</a></h2>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>$ npm install --save path
</pre></div>
</div>
</div>
...
<p>MIT</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-path-0.12.7-d4dc2a506c4ce2197eb481ebfcd5b36c0140b10f-integrity/node_modules/path"
        },

...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-loader-utils-2.0.0-e4cace5b816d425a166b5f097e10cd12b36064b0-integrity/node_modules/loader-utils/README.md"><button type="button"
...
<li><p><code class="docutils literal notranslate"><span class="pre">[contenthash]</span></code> the hash of <code class="docutils literal notranslate"><span class="pre">options.content</span></code> (Buffer) (by default it’s the hex digest of the md4 hash)</p></li>
...
<li><p><code class="docutils literal notranslate"><span class="pre">[hash]</span></code> the hash of <code class="docutils literal notranslate"><span class="pre">options.content</span></code> (Buffer) (by default it’s the hex digest of the md4 hash)</p></li>
...
<span class="c1">// use sha512 hash instead of md4 and with only 7 chars of base64</span>

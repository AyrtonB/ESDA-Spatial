...
<html>
  <head>
    ...
    <title>vega5-extension &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../../_sources/.cache/yarn/v6/npm-@jupyterlab-vega5-extension-2.2.0-afaf129b1e102ed100a9436b858ce5117c3803f8-integrity/node_modules/@jupyterlab/vega5-extension/README.md"><button type="button"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="vega5-extension">
<h1>vega5-extension<a class="headerlink" href="#vega5-extension" title="Permalink to this headline">¶</a></h1>
<p>A JupyterLab extension for rendering <a class="reference external" href="https://vega.github.io/vega">Vega</a> 5 and <a class="reference external" href="https://vega.github.io/vega-lite">Vega-Lite</a> 3.</p>
<p><img alt="demo" src="http://g.recordit.co/USoTkuCOfR.gif" /></p>
...
<p>To render Vega-Lite output in IPython:</p>
...
<span class="n">display</span><span class="p">({</span>
    <span class="s2">&quot;application/vnd.vegalite.v3+json&quot;</span><span class="p">:</span> <span class="p">{</span>
        <span class="s2">&quot;$schema&quot;</span><span class="p">:</span> <span class="s2">&quot;https://vega.github.io/schema/vega-lite/v3.json&quot;</span><span class="p">,</span>
...
<p>Using the <a class="reference external" href="https://github.com/altair-viz/altair">Altair library</a>:</p>
...
<p>Provide Vega-Embed options via metadata:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">IPython.display</span> <span class="kn">import</span> <span class="n">display</span>
...
<span class="p">},</span> <span class="n">metadata</span><span class="o">=</span><span class="p">{</span>
    <span class="s2">&quot;application/vnd.vegalite.v2+json&quot;</span><span class="p">:</span> <span class="p">{</span>
        <span class="s2">&quot;embed_options&quot;</span><span class="p">:</span> <span class="p">{</span>
            <span class="s2">&quot;actions&quot;</span><span class="p">:</span> <span class="kc">False</span>
        <span class="p">}</span>
    <span class="p">}</span>
<span class="p">},</span> <span class="n">raw</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
</pre></div>
</div>
<p>Provide Vega-Embed options via Altair:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">altair</span> <span class="k">as</span> <span class="nn">alt</span>

<span class="n">alt</span><span class="o">.</span><span class="n">renderers</span><span class="o">.</span><span class="n">enable</span><span class="p">(</span><span class="s1">&#39;default&#39;</span><span class="p">,</span> <span class="n">embed_options</span><span class="o">=</span><span class="p">{</span><span class="s1">&#39;actions&#39;</span><span class="p">:</span> <span class="kc">False</span><span class="p">})</span>
...
<p>To render a <code class="docutils literal notranslate"><span class="pre">.vl</span></code>, <code class="docutils literal notranslate"><span class="pre">.vg</span></code>, <code class="docutils literal notranslate"><span class="pre">vl.json</span></code> or <code class="docutils literal notranslate"><span class="pre">.vg.json</span></code> file, simply open it:</p>
</div>
...
<p>See the <a class="reference external" href="https://github.com/jupyterlab/jupyterlab/blob/master/CONTRIBUTING.md">JupyterLab Contributor Documentation</a>.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-@jupyterlab-vega5-extension-2.2.0-afaf129b1e102ed100a9436b858ce5117c3803f8-integrity/node_modules/@jupyterlab/vega5-extension"
        },

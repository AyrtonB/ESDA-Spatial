...
<html>
  <head>
    ...
    <title>flush-write-stream &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-flush-write-stream-1.1.1-8dd7d873a1babc207d94ead0c2e0e44276ebf2e8-integrity/node_modules/flush-write-stream/README.md"><button type="button"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="flush-write-stream">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">writer</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;flush-write-stream&#39;</span><span class="p">)</span>

<span class="kd">var</span> <span class="nx">ws</span> <span class="o">=</span> <span class="nx">writer</span><span class="p">(</span><span class="nx">write</span><span class="p">,</span> <span class="nx">flush</span><span class="p">)</span>
...
<div class="section" id="var-ws-writer-options-write-flush">
...
<div class="section" id="var-ws-writer-obj-options-write-flush">
...
<p>MIT</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-flush-write-stream-1.1.1-8dd7d873a1babc207d94ead0c2e0e44276ebf2e8-integrity/node_modules/flush-write-stream"
        },

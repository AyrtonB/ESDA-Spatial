...
<html>
  <head>
    ...
    <title>ws: a Node.js WebSocket library &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-ws-6.2.1-442fdf0a47ed64f59b6a5d8ff130f4748ed524fb-integrity/node_modules/ws/README.md"><button type="button"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="ws-a-node-js-websocket-library">
...
<a class="reference external" href="https://travis-ci.org/websockets/ws"><img alt="Linux Build" src="https://img.shields.io/travis/websockets/ws/master.svg?logo=travis" /></a>
<a class="reference external" href="https://ci.appveyor.com/project/lpinca/ws"><img alt="Windows Build" src="https://img.shields.io/appveyor/ci/lpinca/ws/master.svg?logo=appveyor" /></a>
<a class="reference external" href="https://coveralls.io/github/websockets/ws"><img alt="Coverage Status" src="https://img.shields.io/coveralls/websockets/ws/master.svg" /></a></p>
...
<div class="section" id="opt-in-for-performance-and-spec-compliance">
...
<div class="section" id="websocket-compression">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">WebSocket</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<span class="kr">const</span> <span class="nx">wss</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">WebSocket</span><span class="p">.</span><span class="nx">Server</span><span class="p">({</span>
  <span class="nx">port</span><span class="o">:</span> <span class="mf">8080</span><span class="p">,</span>
  <span class="nx">perMessageDeflate</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">zlibDeflateOptions</span><span class="o">:</span> <span class="p">{</span>
      <span class="c1">// See zlib defaults.</span>
      <span class="nx">chunkSize</span><span class="o">:</span> <span class="mf">1024</span><span class="p">,</span>
      <span class="nx">memLevel</span><span class="o">:</span> <span class="mf">7</span><span class="p">,</span>
      <span class="nx">level</span><span class="o">:</span> <span class="mf">3</span>
    <span class="p">},</span>
    <span class="nx">zlibInflateOptions</span><span class="o">:</span> <span class="p">{</span>
      <span class="nx">chunkSize</span><span class="o">:</span> <span class="mf">10</span> <span class="o">*</span> <span class="mf">1024</span>
    <span class="p">},</span>
    ...
    <span class="nx">serverMaxWindowBits</span><span class="o">:</span> <span class="mf">10</span><span class="p">,</span> <span class="c1">// Defaults to negotiated value.</span>
    <span class="c1">// Below options specified as default values.</span>
    <span class="nx">concurrencyLimit</span><span class="o">:</span> <span class="mf">10</span><span class="p">,</span> <span class="c1">// Limits zlib concurrency for perf.</span>
    <span class="nx">threshold</span><span class="o">:</span> <span class="mf">1024</span> <span class="c1">// Size (in bytes) below which messages</span>
...
<div class="section" id="sending-and-receiving-text-data">
...
<span class="nx">ws</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;open&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="nx">open</span><span class="p">()</span> <span class="p">{</span>
  <span class="kr">const</span> <span class="nx">array</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Float32Array</span><span class="p">(</span><span class="mf">5</span><span class="p">);</span>

  <span class="k">for</span> <span class="p">(</span><span class="kd">var</span> <span class="nx">i</span> <span class="o">=</span> <span class="mf">0</span><span class="p">;</span> <span class="nx">i</span> <span class="o">&lt;</span> <span class="nx">array</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span> <span class="o">++</span><span class="nx">i</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">array</span><span class="p">[</span><span class="nx">i</span><span class="p">]</span> <span class="o">=</span> <span class="nx">i</span> <span class="o">/</span> <span class="mf">2</span><span class="p">;</span>
  <span class="p">}</span>
...
<div class="section" id="simple-server">
<h3>Simple server<a class="headerlink" href="#simple-server" title="Permalink to this headline">¶</a></h3>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">WebSocket</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>

<span class="kr">const</span> <span class="nx">wss</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">WebSocket</span><span class="p">.</span><span class="nx">Server</span><span class="p">({</span> <span class="nx">port</span><span class="o">:</span> <span class="mf">8080</span> <span class="p">});</span>
...
<div class="section" id="external-http-s-server">
...
<div class="section" id="multiple-servers-sharing-a-single-http-s-server">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">http</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http&#39;</span><span class="p">);</span>
<span class="kr">const</span> <span class="nx">WebSocket</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ws&#39;</span><span class="p">);</span>
...
<div class="section" id="server-broadcast">
...
<div class="section" id="echo-websocket-org-demo">
...
<div class="section" id="error-handling-best-practices">
...
<div class="section" id="how-to-get-the-ip-address-of-the-client">
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="nx">wss</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;connection&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="nx">connection</span><span class="p">(</span><span class="nx">ws</span><span class="p">,</span> <span class="nx">req</span><span class="p">)</span> <span class="p">{</span>
  <span class="kr">const</span> <span class="nx">ip</span> <span class="o">=</span> <span class="nx">req</span><span class="p">.</span><span class="nx">headers</span><span class="p">[</span><span class="s1">&#39;x-forwarded-for&#39;</span><span class="p">].</span><span class="nx">split</span><span class="p">(</span><span class="sr">/\s*,\s*/</span><span class="p">)[</span><span class="mf">0</span><span class="p">];</span>
<span class="p">});</span>
</pre></div>
</div>
</div>
<div class="section" id="how-to-detect-and-close-broken-connections">
...
<span class="kd">function</span> <span class="nx">heartbeat</span><span class="p">()</span> <span class="p">{</span>
  <span class="nx">clearTimeout</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">pingTimeout</span><span class="p">);</span>

  <span class="c1">// Use `WebSocket#terminate()` and not `WebSocket#close()`. Delay should be</span>
  <span class="c1">// equal to the interval at which your server sends out pings plus a</span>
  <span class="c1">// conservative assumption of the latency.</span>
  <span class="k">this</span><span class="p">.</span><span class="nx">pingTimeout</span> <span class="o">=</span> <span class="nx">setTimeout</span><span class="p">(()</span> <span class="p">=&gt;</span> <span class="p">{</span>
    <span class="k">this</span><span class="p">.</span><span class="nx">terminate</span><span class="p">();</span>
  <span class="p">},</span> <span class="mf">30000</span> <span class="o">+</span> <span class="mf">1000</span><span class="p">);</span>
<span class="p">}</span>

<span class="kr">const</span> <span class="nx">client</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">WebSocket</span><span class="p">(</span><span class="s1">&#39;wss://echo.websocket.org/&#39;</span><span class="p">);</span>

<span class="nx">client</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;open&#39;</span><span class="p">,</span> <span class="nx">heartbeat</span><span class="p">);</span>
<span class="nx">client</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;ping&#39;</span><span class="p">,</span> <span class="nx">heartbeat</span><span class="p">);</span>
<span class="nx">client</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;close&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="nx">clear</span><span class="p">()</span> <span class="p">{</span>
  <span class="nx">clearTimeout</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">pingTimeout</span><span class="p">);</span>
<span class="p">});</span>
</pre></div>
</div>
</div>
<div class="section" id="how-to-connect-via-a-proxy">
...
<p><span class="xref myst">MIT</span></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-ws-6.2.1-442fdf0a47ed64f59b6a5d8ff130f4748ed524fb-integrity/node_modules/ws"
        },

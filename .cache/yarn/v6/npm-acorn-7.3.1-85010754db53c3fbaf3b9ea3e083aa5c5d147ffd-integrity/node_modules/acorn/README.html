...
<html>
  <head>
    ...
    <title>Acorn &#8212; Spatial Analysis for Energy</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-acorn-7.3.1-85010754db53c3fbaf3b9ea3e083aa5c5d147ffd-integrity/node_modules/acorn/README.md"><button type="button"
...
requests on <a class="reference external" href="https://github.com/acornjs/acorn">github</a>. For questions
...
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>npm install acorn
</pre></div>
</div>
<p>Alternately, you can download the source and build acorn yourself:</p>
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>git clone https://github.com/acornjs/acorn.git
...
<code class="docutils literal notranslate"><span class="pre">input</span></code> parameter is a string, <code class="docutils literal notranslate"><span class="pre">options</span></code> can be undefined or an object
setting some of the options listed below. The return value will be an
abstract syntax tree object as specified by the <a class="reference external" href="https://github.com/estree/estree">ESTree
spec</a>.</p>
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kd">let</span> <span class="nx">acorn</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn&quot;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">acorn</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s2">&quot;1 + 1&quot;</span><span class="p">));</span>
</pre></div>
</div>
...
<p>Options can be provided by passing a second argument, which should be
an object containing any of these fields:</p>
<ul>
...
<li><p><strong>allowAwaitOutsideFunction</strong>: By default, <code class="docutils literal notranslate"><span class="pre">await</span></code> expressions can
only appear inside <code class="docutils literal notranslate"><span class="pre">async</span></code> functions. Setting this option to
<code class="docutils literal notranslate"><span class="pre">true</span></code> allows to have top-level <code class="docutils literal notranslate"><span class="pre">await</span></code> expressions. They are
still not allowed in non-<code class="docutils literal notranslate"><span class="pre">async</span></code> functions, though.</p></li>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="p">{</span>
  <span class="s2">&quot;type&quot;</span><span class="o">:</span> <span class="s2">&quot;Line&quot;</span> <span class="o">|</span> <span class="s2">&quot;Block&quot;</span><span class="p">,</span>
  <span class="s2">&quot;value&quot;</span><span class="o">:</span> <span class="s2">&quot;comment text&quot;</span><span class="p">,</span>
  <span class="s2">&quot;start&quot;</span><span class="o">:</span> <span class="nb">Number</span><span class="p">,</span>
  <span class="s2">&quot;end&quot;</span><span class="o">:</span> <span class="nb">Number</span><span class="p">,</span>
  <span class="c1">// If `locations` option is on:</span>
  <span class="s2">&quot;loc&quot;</span><span class="o">:</span> <span class="p">{</span>
    <span class="s2">&quot;start&quot;</span><span class="o">:</span> <span class="p">{</span><span class="nx">line</span><span class="o">:</span> <span class="nb">Number</span><span class="p">,</span> <span class="nx">column</span><span class="o">:</span> <span class="nb">Number</span><span class="p">}</span>
    <span class="s2">&quot;end&quot;</span><span class="o">:</span> <span class="p">{</span><span class="nx">line</span><span class="o">:</span> <span class="nb">Number</span><span class="p">,</span> <span class="nx">column</span><span class="o">:</span> <span class="nb">Number</span><span class="p">}</span>
  <span class="p">},</span>
  <span class="c1">// If `ranges` option is on:</span>
  <span class="s2">&quot;range&quot;</span><span class="o">:</span> <span class="p">[</span><span class="nb">Number</span><span class="p">,</span> <span class="nb">Number</span><span class="p">]</span>
<span class="p">}</span>
</pre></div>
</div>
<p>Note that you are not allowed to call the parser from the
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="k">for</span> <span class="p">(</span><span class="kd">let</span> <span class="nx">token</span> <span class="k">of</span> <span class="nx">acorn</span><span class="p">.</span><span class="nx">tokenizer</span><span class="p">(</span><span class="nx">str</span><span class="p">))</span> <span class="p">{</span>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">acorn</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn&quot;</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">jsx</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn-jsx&quot;</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">JSXParser</span> <span class="o">=</span> <span class="nx">acorn</span><span class="p">.</span><span class="nx">Parser</span><span class="p">.</span><span class="nx">extend</span><span class="p">(</span><span class="nx">jsx</span><span class="p">());</span>
<span class="nx">JSXParser</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s2">&quot;foo(&lt;bar/&gt;)&quot;</span><span class="p">);</span>
</pre></div>
</div>
...
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/acornjs/acorn-stage3"><code class="docutils literal notranslate"><span class="pre">acorn-stage3</span></code></a>: Parse most stage 3 proposals, bundling:</p>
<ul>
<li><p><a class="reference external" href="https://github.com/acornjs/acorn-class-fields"><code class="docutils literal notranslate"><span class="pre">acorn-class-fields</span></code></a>: Parse <a class="reference external" href="https://github.com/tc39/proposal-class-fields">class fields proposal</a></p></li>
<li><p><a class="reference external" href="https://github.com/acornjs/acorn-import-meta"><code class="docutils literal notranslate"><span class="pre">acorn-import-meta</span></code></a>: Parse <a class="reference external" href="https://github.com/tc39/proposal-import-meta">import.meta proposal</a></p></li>
<li><p><a class="reference external" href="https://github.com/acornjs/acorn-numeric-separator"><code class="docutils literal notranslate"><span class="pre">acorn-numeric-separator</span></code></a>: Parse <a class="reference external" href="https://github.com/tc39/proposal-numeric-separator">numeric separator proposal</a></p></li>
<li><p><a class="reference external" href="https://github.com/acornjs/acorn-private-methods"><code class="docutils literal notranslate"><span class="pre">acorn-private-methods</span></code></a>: parse <a class="reference external" href="https://github.com/tc39/proposal-private-methods">private methods, getters and setters proposal</a>n</p></li>
</ul>
</li>
</ul>
</div>

...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-cacache-13.0.1-a8000c21697089082f85287a1aec6e382024a71c-integrity/node_modules/cacache/README.md"><button type="button"
...
<p><em>Translations: <span class="xref myst">español</span></em></p>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">cacache</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;cacache&#39;</span><span class="p">)</span>
...
of <code class="docutils literal notranslate"><span class="pre">cb()</span></code> resolves, the tmp directory will be automatically deleted once that
promise completes.</p>
...
<span class="p">})</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-cacache-13.0.1-a8000c21697089082f85287a1aec6e382024a71c-integrity/node_modules/cacache"
        },

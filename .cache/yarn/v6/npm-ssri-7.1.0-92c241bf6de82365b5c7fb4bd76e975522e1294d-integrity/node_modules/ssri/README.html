...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-ssri-7.1.0-92c241bf6de82365b5c7fb4bd76e975522e1294d-integrity/node_modules/ssri/README.md"><button type="button"
  ...
  <ul class="nav section-nav flex-column">
   ...
   <li class="toc-h3 nav-item toc-entry">
    ...
    <ul class="nav section-nav flex-column">
     ...
     <li class="toc-h4 nav-item toc-entry">
      <a class="reference internal nav-link" href="#a-name-integrity-merge-a-integrity-merge-otherintegrity-opts">
       <a name="integrity-merge">
       </a>
       <code class="docutils literal notranslate">
        <span class="pre">
         &gt;
        ...
        <span class="pre">
         Integrity#merge(otherIntegrity,
        </span>
        <span class="pre">
         [opts])
        </span>
...
<h1>ssri <a class="reference external" href="https://npm.im/ssri"><img alt="npm version" src="https://img.shields.io/npm/v/ssri.svg" /></a> <a class="reference external" href="https://npm.im/ssri"><img alt="license" src="https://img.shields.io/npm/l/ssri.svg" /></a> <a class="reference external" href="https://travis-ci.org/npm/ssri"><img alt="Travis" src="https://img.shields.io/travis/npm/ssri.svg" /></a> <a class="reference external" href="https://ci.appveyor.com/project/npm/ssri"><img alt="AppVeyor" src="https://ci.appveyor.com/api/projects/status/github/npm/ssri?svg=true" /></a> <a class="reference external" href="https://coveralls.io/github/npm/ssri?branch=latest"><img alt="Coverage Status" src="https://coveralls.io/repos/github/npm/ssri/badge.svg?branch=latest" /></a><a class="headerlink" href="#ssri-npm-version-license-travis-appveyor-coverage-status" title="Permalink to this headline">¶</a></h1>
<p><a class="reference external" href="https://github.com/npm/ssri"><code class="docutils literal notranslate"><span class="pre">ssri</span></code></a>, short for Standard Subresource
...
<li><p><a class="reference external" href="#integrity-merge"><code class="docutils literal notranslate"><span class="pre">Integrity#merge</span></code></a></p></li>
...
<div class="section" id="a-name-integrity-merge-a-integrity-merge-otherintegrity-opts">
<h4><a name="integrity-merge"></a> <code class="docutils literal notranslate"><span class="pre">&gt;</span> <span class="pre">Integrity#merge(otherIntegrity,</span> <span class="pre">[opts])</span></code><a class="headerlink" href="#a-name-integrity-merge-a-integrity-merge-otherintegrity-opts" title="Permalink to this headline">¶</a></h4>
<p>Safely merges another IntegrityLike or integrity string into an <code class="docutils literal notranslate"><span class="pre">Integrity</span></code>
object.</p>
<p>If the other integrity value has any algorithms in common with the current
object, then the hash digests must match, or an error is thrown.</p>
<p>Any new hashes will be added to the current object’s set.</p>
<p>This is useful when an integrity value may be upgraded with a stronger
algorithm, you wish to prevent accidentally supressing integrity errors by
overwriting the expected integrity value.</p>
<div class="section" id="id4">
<h5>Example<a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h5>
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">data</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">&#39;data.txt&#39;</span><span class="p">)</span>

<span class="c1">// integrity.txt contains &#39;sha1-X1UT+IIv2+UUWvM7ZNjZcNz5XG4=&#39;</span>
<span class="c1">// because we were young, and didn&#39;t realize sha1 would not last</span>
<span class="kr">const</span> <span class="nx">expectedIntegrity</span> <span class="o">=</span> <span class="nx">ssri</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">&#39;integrity.txt&#39;</span><span class="p">,</span> <span class="s1">&#39;utf8&#39;</span><span class="p">))</span>
<span class="kr">const</span> <span class="nx">match</span> <span class="o">=</span> <span class="nx">ssri</span><span class="p">.</span><span class="nx">checkData</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span> <span class="nx">expectedIntegrity</span><span class="p">,</span> <span class="p">{</span>
  <span class="nx">algorithms</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;sha512&#39;</span><span class="p">,</span> <span class="s1">&#39;sha1&#39;</span><span class="p">]</span>
<span class="p">})</span>
<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="nx">match</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">throw</span> <span class="k">new</span> <span class="nb">Error</span><span class="p">(</span><span class="s1">&#39;data corrupted or something!&#39;</span><span class="p">)</span>
<span class="p">}</span>

<span class="c1">// get a stronger algo!</span>
<span class="k">if</span> <span class="p">(</span><span class="nx">match</span> <span class="o">&amp;&amp;</span> <span class="nx">match</span><span class="p">.</span><span class="nx">algorithm</span> <span class="o">!==</span> <span class="s1">&#39;sha512&#39;</span><span class="p">)</span> <span class="p">{</span>
  <span class="kr">const</span> <span class="nx">updatedIntegrity</span> <span class="o">=</span> <span class="nx">ssri</span><span class="p">.</span><span class="nx">fromData</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span> <span class="p">{</span> <span class="nx">algorithms</span><span class="o">:</span> <span class="p">[</span><span class="s1">&#39;sha512&#39;</span><span class="p">]</span> <span class="p">})</span>
  <span class="nx">expectedIntegrity</span><span class="p">.</span><span class="nx">merge</span><span class="p">(</span><span class="nx">updatedIntegrity</span><span class="p">)</span>
  <span class="nx">fs</span><span class="p">.</span><span class="nx">writeFileSync</span><span class="p">(</span><span class="s1">&#39;integrity.txt&#39;</span><span class="p">,</span> <span class="nx">expectedIntegrity</span><span class="p">.</span><span class="nx">toString</span><span class="p">())</span>
  <span class="c1">// file now contains</span>
  <span class="c1">// &#39;sha1-X1UT+IIv2+UUWvM7ZNjZcNz5XG4= sha512-yzd8ELD1piyANiWnmdnpCL5F52f10UfUdEkHywVZeqTt0ymgrxR63Qz0GB7TKPoeeZQmWCaz7T1+9vBnypkYWg==&#39;</span>
<span class="p">}</span>
</pre></div>
</div>
</div>
...
<span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">ssri</span><span class="p">.</span><span class="nx">integrityStream</span><span class="p">({</span><span class="nx">integrity</span><span class="p">}))</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-ssri-7.1.0-92c241bf6de82365b5c7fb4bd76e975522e1294d-integrity/node_modules/ssri"
        },
